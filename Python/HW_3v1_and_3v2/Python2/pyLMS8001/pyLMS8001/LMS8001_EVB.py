...
class LMS8001_EVB(object):
    ...
    def __init__(self, portName='/dev/ttyACM0', MPW_YEAR=2024, verbose=0):
        """
        ...
        if not (MPW_YEAR==2024 or MPW_YEAR==2015):
            raise Exception("Error! MPW_YEAR Valid Values: {2024, 2015}")
        
        
        self.LMS8001 = LMS8001(SPIwriteFn=self.LMS8001_Write, SPIreadFn=self.LMS8001_Read, MPW_YEAR=MPW_YEAR, verbose=verbose)
