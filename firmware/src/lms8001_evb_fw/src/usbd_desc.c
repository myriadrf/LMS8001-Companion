...
#define USBD_MANUFACTURER_STRING        "Lime Microsystems"

#define USBD_PRODUCT_HS_STRING          "LMS8001_EVB"
#define USBD_SERIALNUMBER_HS_STRING     "LMS8001_EVB"

#define USBD_PRODUCT_FS_STRING          "LMS8001_EVB"
#define USBD_SERIALNUMBER_FS_STRING     "LMS8001_EVB"

#define USBD_CONFIGURATION_HS_STRING    "VCP"
#define USBD_INTERFACE_HS_STRING        "VCP"

#define USBD_CONFIGURATION_FS_STRING    "VCP"
#define USBD_INTERFACE_FS_STRING        "VCP"
/**
  * @}
  */ 
...
void Get_SerialNum(void)
{
  ...
  if (Device_Serial0 != 0)
  {
    ...
    IntToUnicode (Device_Serial0, &USBD_StrDesc[2] , 8);
    IntToUnicode (Device_Serial1, &USBD_StrDesc[18], 4);
    USBD_StrDesc[22]= 0;
    USBD_StrDesc[23]=0;
  }
}
